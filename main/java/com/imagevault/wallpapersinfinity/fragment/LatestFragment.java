...
public class LatestFragment extends Fragment {
    ...
    private final String API_KEY = ""; // Store this in BuildConfig
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Initialize views
        progressBar = rootView.findViewById(R.id.progressBartets);
        recyclerView = rootView.findViewById(R.id.recyclerViewlatest);
        ...
        List<String> categories = Arrays.asList("cars",
                "Ecosystem",
                "Green Energy",
                "Climate Change",
                "Biodiversity",
